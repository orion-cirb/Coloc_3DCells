...
public class StarDist2DModel {
    ...
    static {
       // MODELS.put(MODEL_DSB2018_PAPER, new StarDist2DModel(StarDist2DModel.class.getClassLoader().getResource("models/dsb2018_paper.zip"), 0.417819, 0.5, 8, 48));
        MODELS.put(MODEL_DSB2018_HEAVY_AUGMENTATION, new StarDist2DModel(StarDist2DModel.class.getClassLoader().getResource("models/dsb2018_heavy_augment.zip"), 0.479071, 0.3, 16, 96));
        //MODELS.put(MODEL_HE_HEAVY_AUGMENTATION, new StarDist2DModel(StarDist2DModel.class.getClassLoader().getResource("models/he_heavy_augment.zip"), 0.692478, 0.3, 16, 96));
    }
